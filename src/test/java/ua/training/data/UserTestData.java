...
public class UserTestData {
    ...
    public User ADMIN_USER = new User.Builder()
                ...
                .setUsername("annat").setAge(22).setLastName("Doe").setFirstName("Jane").setPassword(PASSWORD_1).build();
    ...
    public User USER_2 = new User.Builder()
                ...
                .setUsername("dfgh").setAge(32).setLastName("Jiel").setFirstName("Jake")
    ...
    public List<User> USERS_LIST = new ArrayList<>(Arrays.asList(
                new User.Builder()
                        .setId(2L).setWeight(60).setRole("ROLE_ADMIN").setHeight(170).setGender("MALE").setActivityLevel("SECOND")
                        .setUsername("annat").setAge(22).setLastName("Doe").setFirstName("Jane")
                ...
                new User.Builder()
                        ...
                        .setUsername("tommy").setAge(42).setLastName("Ковальва").setFirstName("Юлія")
                        .setPassword(PASSWORD_3).build(),
                new User.Builder()
                        .setId(5L).setWeight(77).setRole("ROLE_USER").setHeight(190).setGender("MALE").setActivityLevel("FIFTH")
                        .setUsername("fiveone").setAge(34).setLastName("Bittlesome").setFirstName("Max")
                ...
                new User.Builder()
                        ...
                        .setUsername("lrrred").setAge(18).setLastName("Loganson").setFirstName("Carl")
